...
public class PlayerPG extends Player{
	...
	protected double trbW = 0.1;
	protected double astW = 0.3;
	protected double blkW = 0.1;
	protected double stlW = 0.3;
	
	
	
	public PlayerPG(String playerName, double pts, double trb, double ast, double blk, double stl) {
		super(playerName, "PG", pts, trb, ast, blk, stl);
