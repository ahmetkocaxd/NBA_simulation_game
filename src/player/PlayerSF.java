...
public class PlayerSF extends Player{
	...
	protected double ptsW = 0.3;
	protected double trbW = 0.2;
	protected double astW = 0.2;
	protected double blkW = 0.1;
	protected double stlW = 0.2;
	
	
	public PlayerSF(String playerName, double pts, double trb, double ast, double blk, double stl) {
		super(playerName, "SF", pts, trb, ast, blk, stl);
